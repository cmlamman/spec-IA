...
h = H0/100
from geometry_functions.coordinate_functions import get_points, deg_to_rad, get_pa, get_sep_pa
    
def find_cluster_2D(catalog, sky_sep_max=1e-4, los_max=1, max_n=5):
...
def calculate_rel_ang_ra_dec(query_catalog, catalog, sep_max = deg_to_rad(.5), sep_min = False, max_neighbors=100, pimax=30):
    ...
    pa_rel = centers_m['THETA'] - pa.value  # in rad
